...
- **20 language bridges** planned, 5 ready (C, C++, Swift, Nim, Zig) — C FFI base, then native socket clients for each language
...
| 2 | **C++**, **Swift**, **Nim**, Lua, Tcl, **Zig** | C FFI consumers | 4/6 |
